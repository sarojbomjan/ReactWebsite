...
const Navbar = () => {
    ...
    return (
        <nav className="w-full flex py-6 justify-between items-center navbar sticky top-0 ">
            ...
            <ul className="list-none sm:flex hidden justify-end items-center flex-1">  {/* mobile navbar */}
            ...
            <div className="sm:hidden flex flex-1 justify-end items-center">
                ...
                <div className={`${toggle ? 'flex' : 'hidden'} p-6 bg-black-gradient absolute top-20 right-0 mx-4 my-2 min-w-[140px] rounded-xl sidebar`}>
                    ...
                    <ul className="list-none flex justify-end items-center flex-col">  {/* mobile navbar */}
                        {navLinks.map((nav, index) => (
                            <li key={nav.id}
